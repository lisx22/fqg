        ...
        <div class="passport-ui-top">
            <div class="container">
                <div class="fr">
                    ...
                    <a target="_blank" href="https://mall.fenqile.com/intro/detail.html" data-fql-stat="WWW.MAIN.HEADER.DETAIL">分期介绍</a>
                    <span class="passport-ui-line">|</span>
                    <a style="color: red;" href="javascript:;" class="js-g-report-price">举报有奖</a>
                </div>
            </div>
        </div>
        <div class="passport-ui-main">
            <div class="container header-main clear">
                                    <div class="fr header-login">
                        已有账号？  <a href="https://passport.fenqile.com/">立即登录</a>
                    </div>
                                <div class="fl clear header-headline">
                    <div class="fl header-logo">
                        <a href="https://www.fenqile.com/">
                            <img height="38" width="120" src="./register_files/logo.png" alt="分期乐">
                        </a>
                    </div>
...
<div class="container container-fff">
    <div class="passport-ui-title">
        注册新用户
    </div>
    <form class="passport-ui-inner js-g-module-form js-g-module-form-1528078066424a628860038783313000" id="submit_form" novalidate="novalidate">
        <div class="passport-ui-form">
            <ul class="">
                <li class="form-input clear js-input-wrap">
                    <label class="fl tit">手机号码</label>
                    <div class="fl">
                        <input type="text" name="mobile" id="username" placeholder="请输入有效手机号" data-type="mobile" maxlength="11" data-required="" data-behavior-collection="true" data-collection-key="mobile" minlength="11" class="js-g-module-form-el">
                        
                    </div>
                </li>
                <!--<li class="form-sms clear js-input-wrap fn-hide" id="img_code_wrap">-->
                    <!--<label class="fl tit">验证码</label>-->
                    <!--<div class="fl">-->
                        <!--<input class="fl js-g-module-form-el" type="text" id="imgcode" name="imgcode" placeholder="图片验证码" autocomplete="off" maxlength="4" data-type="imgCode" data-behavior-collection="" data-collection-key="imgcode" required="" minlength="4" autocorrect="off" autocapitalize="characters">-->
                        <!--&lt;!&ndash;<a href="javascript:;"><img src="./register_files/getimage" width="80" height="46" alt="图片验证码" id="refresh_imgcode" align="top"></a>&ndash;&gt;-->
                    <!--</div>-->
                <!--</li>-->
                <li class="form-sms clear js-input-wrap">
                    <label class="fl tit">短信验证码</label>
                    <div class="fl">
                        <input class="fl js-g-module-form-el" type="text" name="sms_code" id="inputCode" placeholder="请输入验证码" data-type="smsCode" maxlength="6" data-required="" data-behavior-collection="true" data-collection-key="sms_code" minlength="6">
                        <button type="button" class="btn js-g-module-countdown-button-1528078066434a436264603161990340" id="sendCode">获取验证码</button>
                    </div>
                </li>
                <li class="form-input clear js-input-wrap">
                    <label class="fl tit">登录密码</label>
                    <div class="fl">
                        <input type="password" name="passwd" id="password" placeholder="请输入6-16位字符或数字" maxlength="16" data-type="password" data-required="" data-min-length="6" data-short="密码长度至少6位" data-behavior-collection="true" data-collection-key="passwd" minlength="6" class="js-g-module-form-el">
                    </div>
                </li>
                <!--<li class="form-input clear js-input-wrap fn-hide">-->
                    <!--<label class="fl tit">确定密码</label>-->
                    <!--<div class="fl">-->
                        <!--<input type="password" placeholder="确认登录密码" maxlength="16" data-type="password" data-matches="#passwd" data-required="" data-diff="与登录密码不一致" data-name="确认密码" minlength="6" class="js-g-module-form-el">-->
                    <!--</div>-->
                <!--</li>-->
                <li class="form-input clear js-input-wrap">
                    <label class="fl tit">交易密码</label>
                    <div class="fl">
                        <input type="password" name="pay_pwd" id="loginpassword" placeholder="与登录密码不同" maxlength="16" data-type="password" data-different="#passwd" data-required="" data-min-length="6" data-same="交易密码和登录密码不能相同" data-short="密码长度至少6位" data-behavior-collection="true" data-collection-key="pay_pwd" minlength="6" class="js-g-module-form-el">
                    </div>
                </li>
                <!--<li class="form-input clear js-input-wrap">-->
                    <!--<label class="fl tit">确定密码</label>-->
                    <!--<div class="fl">-->
                         <!--<input type="password" placeholder="确认交易密码" maxlength="16" data-type="password" data-matches="#pay_pwd" data-required="" data-diff="与交易密码不一致" data-name="确认密码" minlength="6" class="js-g-module-form-el">-->
                    <!--</div>-->
                <!--</li>-->
                <li class="form-btn clear">
                    <label class="fl tit">&nbsp;</label>
                    <div class="fl">
                        <button onclick="login()"  class="btn" id="submit1" data-loading-text="注册中...">同意协议并注册</button>
                    </div>
                </li>
                <li class="clear form-protocol">
                    <label class="fl tit">&nbsp;</label>
                    <div class="fl fn-pr">
                        <input class="checkbox js-g-module-form-el" checked="" type="checkbox" id="agreement">
                        <b class="forcheckbox"></b>
                        <label class="label" for="agreement">同意
                            <a href="https://mall.fenqile.com/protocol/fe_ex_register.html" target="_blank">《分期乐注册协议》</a>
                            <a href="https://mall.fenqile.com/protocol/fe_ex_privacy_agreement.html" target="_blank">《分期乐隐私保护政策》</a>
                        </label>
                    </div>
                </li>
            </ul>
...
<footer>
    <div class="footer passport-footer">
        <div class="container fn-clear">
            <div class="fn-left">
                <a href="https://mall.fenqile.com/" class="footer-logo"></a>
                <a href="https://search.szfw.org/cert/l/CX20141112008657008753" target="_blank" rel="noopener noreferrer" class="footer-ico-cx"></a>
            </div>
            <div class="fn-left">
                <a href="https://mall.fenqile.com/intro/about.html">关于我们</a><span class="line">|</span><a href="http://shop.fenqile.com/">卖家入驻</a><span class="line">|</span><a href="javascript:;" class="js-g-report-price">我要举报</a><span class="line">|</span><a href="https://dreamclub.fenqile.com/">加入我们</a><span class="line">|</span><a href="http://sale.fenqile.com/event/detail.html?act=20140825" target="_blank">上门自提</a>
                &nbsp;&nbsp;<a href="http://www.miibeian.gov.cn/" target="_blank" rel="noopener noreferrer">粤ICP备14041530号-1</a>&nbsp;&nbsp;<a href="https://mall.fenqile.com/intro/icp.html" target="_blank"> 增值电信业务经营许可证B2-20140262</a><br>Copyright © 2013-2018 Fenqile All Rights Reserved 深圳市分期乐网络科技有限公司 版权所有<p></p>
            </div>
            <div class="fn-right">
                <div class="fn-right">
                    <script id="ebsgovicon" src="./register_files/govicon.js.下载" type="text/javascript" charset="utf-8"></script><a href="http://szcert.ebs.org.cn/e2530f78-693c-4abf-b9a5-0a9259209b6d" target="_blank"><img src="./register_files/govIcon.gif" title="深圳市市场监督管理局企业主体身份公示" alt="深圳市市场监督管理局企业主体身份公示" width="41" height="56" border="0" style="border-width:0px;border:hidden; border:none;"></a><script type="text/javascript" src="./register_files/iplookup.php"></script>
                </div>
...
<!-- 百度统计代码，不要随意更改，只在预发布以上环境引入 --><script>document.domain="fenqile.com";</script>
<script charset="utf-8" type="text/javascript" src="./register_files/saved_resource"></script>
<script charset="utf-8" type="text/javascript" src="./register_files/saved_resource(1)"></script>
<script>G_SPEED_POINT_TIME.G_JS={ID:4,DATA:[G_PAGE_LOAD_TIME,(new Date).getTime()]};</script>
<script type="text/javascript" src="./register_files/index--e1b30a5e35.js.下载"></script>
<script>
    (function () {
        _fmOpt = {
            token: "82388591e462e5a3e404fa1212eb74aba5b1f8bc",
            partner: 'fenqile',
            appName: 'fenqile_web',
        ...
        cimg.src = "https://fp.fraudmetrix.cn/fp/clear.png?partnerCode=fenqile&appName=fenqile_web&tokenId=" + _fmOpt.token;
...
<div tabindex="-1" id="fql_box_152807806640147290" style="display: none; position: fixed; left: 0px; top: 0px; bottom: auto; right: auto; margin: 0px; padding: 0px; outline: 0px; border: 0px none; background: transparent;"><div class="fui-ui-box" data-key="box">    <div class="fui-ui-box-title js-g-module-box-title" data-key="title-cls-ctrl"><span data-key="title">分期乐</span><button data-id="close" class="fui-ui-box-close"></button></div>    <div class="fui-ui-box-body js-g-module-box-body" data-key="body">        <div data-key="content" class="js-g-module-box-content"></div>        <div data-key="button" class="fui-ui-box-btn fui-ui-box-btn-sm js-g-module-box-button"></div>    </div></div></div><div tabindex="-1" id="fql_box_152807806642243274" style="display: none; position: fixed; left: 0px; top: 0px; bottom: auto; right: auto; margin: 0px; padding: 0px; outline: 0px; border: 0px none; background: transparent;"><div class="fui-ui-box" data-key="box">    <div class="fui-ui-box-title js-g-module-box-title" data-key="title-cls-ctrl"><span data-key="title">分期乐</span><button data-id="close" class="fui-ui-box-close"></button></div>    <div class="fui-ui-box-body js-g-module-box-body" data-key="body">        <div data-key="content" class="js-g-module-box-content"></div>        <div data-key="button" class="fui-ui-box-btn fui-ui-box-btn-sm js-g-module-box-button"></div>    </div></div></div></body></html>
