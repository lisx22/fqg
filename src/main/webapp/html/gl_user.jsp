...
<html>
<head>
	<base href="<%=request.getContextPath()%>/fqg/"/>
		<meta charset="utf-8" />
						...
						<form class="am-form">
							<table class="am-table am-table-striped am-table-hover table-main">
								...
								<tr>
									...
									<th class="table-author am-hide-sm-only">登录密码</th>
									<th class="table-date am-hide-sm-only">支付密码</th>
									<th class="table-date am-hide-sm-only">学校名称</th>
									<th class="table-date am-hide-sm-only">公司名称</th>
