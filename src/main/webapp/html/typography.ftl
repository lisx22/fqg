				    ...
				    <div class="am-offcanvas-bar admin-offcanvas-bar">
	                    ...
	                    <!-- End User -->
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li><a href="typography.ftl"><span class="am-icon-home"></span> 排版</a></li>
						    <li class="admin-parent">
						      <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span> 页面模块 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
						        <li><a href="admin-user.ftl" class="am-cf"><span class="am-icon-check"></span> 个人资料<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
						        <li><a href="admin-help.ftl"><span class="am-icon-puzzle-piece"></span> 帮助页</a></li>
						        <li><a href="admin-gallery.ftl"><span class="am-icon-th"></span> 相册页面<span class="am-badge am-badge-secondary am-margin-right am-fr">24</span></a></li>
						        <li><a href="admin-log.ftl"><span class="am-icon-calendar"></span> 系统日志</a></li>
						        <li><a href="admin-404.ftl"><span class="am-icon-bug"></span> 404</a></li>
						      </ul>
						    </li>
						    <li><a href="admin-table.ftl"><span class="am-icon-table"></span> 表格</a></li>
						    <li><a href="admin-form.ftl"><span class="am-icon-pencil-square-o"></span> 表单</a></li>
