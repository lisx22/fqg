			...
			<ul class="am-list admin-sidebar-list">
				...
				<li class="admin-parent">
					...
					<ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav5">
						<li><a href="" class="am-cf"> 秒杀商品上架</a></li>
					...
					<div class="am-u-sm-12 am-u-md-6">
						<div class="am-btn-toolbar">
							<div class="am-btn-group am-btn-group-xs">
								...
								<a href="customer/preAdd/" id="add"></a>
					...
					<div class="am-u-sm-12">
						<form class="am-form" action="customer/deletes/" method="post">
							...
							<table class="am-table am-table-striped am-table-hover table-main">
								...
								<#list Customerlist as customers>
                                <tr>
                                    ...
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                ...
                                                <a href="customer/preUpdateCustomer/${customers.customerId}" id="update${customers.customerId}"></a>
                                                ...
                                                <a href="customer/deleteById/${customers.customerId}" id="delete${customers.customerId}"></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    function upPage(){
        ...
        if(first=="0"){
            ...
            window.location = "customer/customerList/"+add;
            $("#first").val(add);
		}
	...
	function downPage() {
        ...
        if(parseInt(first)>=parseInt(pageCount)-1){
            ...
            window.location = "customer/customerList/"+jian;
            $("#first").val(jian);
		}
