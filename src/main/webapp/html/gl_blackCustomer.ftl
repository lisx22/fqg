			...
			<div class="card-box">
					...
					<div class="am-u-sm-12 am-u-md-6">
						<div class="am-btn-toolbar">
							<div class="am-btn-group am-btn-group-xs">
								...
								<a href="blackCustomer/preAdd/" id="add"></a>
								<button id="selectCustomers" type="button" onclick="deleteCustomers3()" class="am-btn am-btn-default"><span class="am-icon-trash-o"></span> 删除</button>
				...
				<div class="am-g">
					<div class="am-u-sm-12">
						<form class="am-form" action=" blackCustomer/deletes/" method="post">
							...
							<table class="am-table am-table-striped am-table-hover table-main" style="table-layout: fixed;">
								...
								<tbody>
								<#list blackCustomerlist as blackCustomers>
									<tr>
										<td><input type="checkbox" name="blackCustomerIds" value="${blackCustomers.blackCustomerId!}"/></td>
										<td>${blackCustomers.blackCustomerId}</td>
										<td style="text-overflow: ellipsis; white-space:nowrap;overflow: hidden;">${blackCustomers.idNumber!}</td>
										<td>${blackCustomers.createTime!}</td>
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button id="deletebut${blackCustomers.blackCustomerId!}" onclick="deleteById(${blackCustomers.blackCustomerId!})" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button>
													<a href="blackCustomer/deleteById/${blackCustomers.blackCustomerId!}" id="delete${blackCustomers.blackCustomerId!}"></a>
												</div>
											</div>
										</td>
									</tr>
							...
							<div class="am-cf">
								...
								<div class="am-fr">
									<ul class="am-pagination">
										...
										<li><a href=" blackCutomer/blackCustomerlist/0">1</a></li>
										<li><a href=" blackCutomer/blackCustomerlist/1">2</a></li>
										<li><a href=" blackCutomer/blackCustomerlist/2">3</a></li>
										<li><a href=" blackCutomer/blackCustomerlist/3">4</a></li>
										<li><a href=" blackCutomer/blackCustomerlist/4">5</a></li>
...
<script>
    ...
    function upPage(){
        ...
        if(first=="0"){
            ...
            window.location = " blackCustomer/blackCustomerList/"+add;
            $("#first").val(add);
		}
	...
	function downPage() {
        ...
        if(parseInt(first)>=parseInt(pageCount)-1){
            ...
            window.location = " commodity/blackCustomerList/"+jian;
            $("#first").val(jian);
		}
    }
