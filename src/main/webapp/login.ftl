...
<div class="container container-fff">
    ...
    <form class="passport-ui-inner js-g-module-form js-g-module-form-1528078066424a628860038783313000" id="login_form" novalidate="novalidate">
        <div class="passport-ui-form">
            <ul class="">
                <li class="form-input clear js-input-wrap">
                    <label class="fl tit">手机号码</label>
                    <div class="fl">
                        <input type="text" name="mobile" id="username" placeholder="请输入有效手机号" data-type="mobile" maxlength="11"  minlength="11" class="js-g-module-form-el">
                    </div>
                </li>
                    <li class="form-sms clear js-input-wrap">
                        <label class="fl tit">验证码</label>
                        <div class="fl">
                            <input style="float: left;width: 220px" type="text" class="text"  name="vcode" id="vocd" placeholder="验证码"><br>
                            <img style="margin-left: 262px;position: absolute;bottom:377px;" id="vcode" src="vcode.do" onclick="changeCode()" width="82px;"height="46px">
                            <!--<input class="fl js-g-module-form-el" type="text" name="sms_code" id="sms_code" placeholder="请输入验证码" data-type="smsCode" maxlength="6" data-required="" data-behavior-collection="true" data-collection-key="sms_code" minlength="6">-->
                        <!--<button type="button" class="btn js-g-module-countdown-button-1528078066434a436264603161990340" id="get_sms_code" data-seconds="60" data-tip="$!{second}秒后重试" data-disable-class="btn-disabled">获取验证码</button>-->
                        </div>
                    </li>
                <li class="form-input clear js-input-wrap">
                    <label class="fl tit">登录密码</label>
                    <div class="fl">
                        <input type="password" name="passwd" id="password" placeholder="请输入6-16位字符或数字" maxlength="16"  minlength="6" class="js-g-module-form-el">
                    </div>
                </li>
                ...
                <!--<li class="form-input clear js-input-wrap">-->
                    ...
                    <!--<div class="fl">-->
                        <!--<input type="password" name="pay_pwd" id="pay_pwd" placeholder="与登录密码不同" maxlength="16" data-type="password" data-different="#passwd" data-required="" data-min-length="6" data-same="交易密码和登录密码不能相同" data-short="密码长度至少6位" data-behavior-collection="true" data-collection-key="pay_pwd" minlength="6" class="js-g-module-form-el">-->
                    <!--</div>-->
                <!--</li>-->
                <!--<li class="form-input clear js-input-wrap">-->
                    <!--<label class="fl tit">确定密码</label>-->
                ...
                <li class="form-btn clear">
                    ...
                    <div class="fl">
                        <button onclick="login()" class="btn" id="register_btn">同意登录</button>
                    </div>
                </li>
...
<div tabindex="-1" id="fql_box_152807806640147290" style="display: none; position: fixed; left: 0px; top: 0px; bottom: auto; right: auto; margin: 0px; padding: 0px; outline: 0px; border: 0px none; background: transparent;"><div class="fui-ui-box" data-key="box">    <div class="fui-ui-box-title js-g-module-box-title" data-key="title-cls-ctrl"><span data-key="title">分期乐</span><button data-id="close" class="fui-ui-box-close"></button></div>    <div class="fui-ui-box-body js-g-module-box-body" data-key="body">        <div data-key="content" class="js-g-module-box-content"></div>        <div data-key="button" class="fui-ui-box-btn fui-ui-box-btn-sm js-g-module-box-button"></div>    </div></div></div><div tabindex="-1" id="fql_box_152807806642243274" style="display: none; position: fixed; left: 0px; top: 0px; bottom: auto; right: auto; margin: 0px; padding: 0px; outline: 0px; border: 0px none; background: transparent;"><div class="fui-ui-box" data-key="box">    <div class="fui-ui-box-title js-g-module-box-title" data-key="title-cls-ctrl"><span data-key="title">分期乐</span><button data-id="close" class="fui-ui-box-close"></button></div>    <div class="fui-ui-box-body js-g-module-box-body" data-key="body">        <div data-key="content" class="js-g-module-box-content"></div>        <div data-key="button" class="fui-ui-box-btn fui-ui-box-btn-sm js-g-module-box-button"></div>    </div></div></div></body></html>
    <script type="text/javascript">
        function login() {
            ...
            $.post(
                "user/login",
                {"username":name,"password":password,"vcode":vcode},
                function (data) {
                    alert(data.code);
                    if (data.code==0){
...
<script type="text/javascript">
    function changeCode(){
        vcode.src = "vcode.do?"+Math.random();
    }
</script>